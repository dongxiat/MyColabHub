...
import torch
import torchaudio
from tqdm import tqdm # Import tqdm trực tiếp
...
def infer_batch_process(
    ...
    # <<< ĐÂY LÀ KHỐI CODE ĐÃ SỬA LỖI >>>
    # Nó sẽ dùng tqdm mặc định nếu chạy từ dòng lệnh, và dùng callback của Gradio nếu được truyền vào
    ...
    for i, gen_text in enumerate(iterable):
        if progress != tqdm and callable(progress):
            try:
                ...
                pass # Bỏ qua lỗi nếu callback có vấn đề
